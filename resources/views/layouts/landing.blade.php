...
<meta content="Silver Class" name="keywords">
<meta content="Make your own silver by yourself" name="description">
...
<title>{{ config('app.name', 'Andre Silver Class') }}</title>
...
<body>
    <!-- Spinner Start -->
    @include('components.layouts.spinner')
    <!-- Spinner End -->
    ...
    <!-- Copyright Start -->
    @include('components.layouts.copyright')
    <!-- Copyright End -->
